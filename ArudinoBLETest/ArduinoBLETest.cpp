...
//                                     (const uint8_t *)"short", sizeof("short") - 1);
    
    // longest length: BLE_GAP_DEVNAME_MAX_LEN // 31
    ble.accumulateAdvertisingPayload(GapAdvertisingData::COMPLETE_LOCAL_NAME,
                                     (const uint8_t *)"LED Cyr Wheel2", sizeof("LED Cyr Wheel2") - 1);
    ...
    // set device name
//    ble_error_t error = ble.setDeviceName((const uint8_t *)"Simple Chat");
    
//    Serial.print("set name result: ");
//    Serial.print(error);
//    Serial.println();
//    
